...
function classificacaoAluno(nota){
    if (nota < 38){
        ...
        return console.log("Aluno aprovado, nota:", notaArredondadaBaixo)
    }
    else{
        let notaArredondadaCima = Math.ceil(nota/5)*5;
        return console.log('Aluno aprovado, nota:', notaArredondadaCima)
    }
}

classificacaoAluno(37)
classificacaoAluno(38)
classificacaoAluno(41)
classificacaoAluno(43)
classificacaoAluno(47)
classificacaoAluno(59)
